...
{
    public class MobileWalletSession
    {
        ...
        public byte[] EncryptSessionPayload(byte[] payload)
        {
            ...
            {
                throw new InvalidOperationException("Cannot encrypt, no session key has been established");
            }
            _mSeqNumberTx++;
        ...
        public byte[] DecryptSessionPayload(byte[] payload)
        {
            ...
            {
                throw new InvalidOperationException("Encrypted messages has invalid sequence number");
            }
        ...
        {
            var publicKey = EcdsaSignatures.DecodeP256PublicKey(otherPublicKey);
        ...
        {
            if (_privateEphemeralKey == null) throw new InvalidOperationException("Ephemeral key not initialized");
